...
<div class="navbar navbar-fixed-top">
  <div class="navbar-inner">
    <div class="container"> <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse"><span
                    class="icon-bar"></span><span class="icon-bar"></span><span class="icon-bar"></span> </a><a class="brand" href="index">Cribpark Service Admin</a>
      <div class="nav-collapse">
        <ul class="nav pull-right">
          <li class=""><a href="adduser" class="dropdown-toggle" data-toggle="dropdown"><i
                            class="icon-cog"></i> Add a New User </a>
            
          </li>
          <li class="dropdown"><a href="logout" class="dropdown-toggle" data-toggle="dropdown"><i
              ...
              <table class="table table-striped table-bordered">
                <thead>
                  <tr>
                    ...
                    <th> Service Type</th>
                    <th class="td-actions">Location</th>
                    <th class="td-actions">Email</th>
                    <th class="td-actions">Phone No.</th>
                    <th class="td-actions">Address</th>
                    <th class="td-actions">Description</th>
                 ...
                 <?php foreach ($orders as $order):?>
                    <tbody>
                  <tr>
                    <td><?php echo $this->Html->link(ucwords($order['Order']['name']), array('controller'=>'Order', 'action'=>'view', $order['Order']['id']));?>
                    </td>
                    <td><?php echo ucwords($order['Order']['type of service']);?></td>
                    <td><?php echo ucwords($order['Order']['location']);?></td>
                    <td><?php echo ucwords($order['Order']['email']);?></td>
                    <td><?php echo ucwords($order['Order']['phone no']);?></td>
                    <td><?php echo ucwords($order['Order']['address']);?></td>
                    <td><?php echo ucwords($order['Order']['description']);?></td>

                    <td><?php echo $this->Form->postLink('Delete ', array('controller'=>'Users', 'action'=>'admin_delete',  $order['Order']['id']), array('confirm'  =>  'Are  you  sure?')) ?></td>
                    
                       <?php //echo ucwords($order['Order']['email']);?> 
